...
let spaceshipColour = spaceship.color;
spaceshipColour = 'glorious gold';
spaceship.numEngines = 7;
delete spaceship['Secret Misson'];
...
let alienShip = {
    ...
    takeOffMessage: function () {
        console.log('Spim... Borp... Glix... Blastoff!');
    },

    retreatMessage: function () {
        console.log(retreatMessage);
    }
}

alienShip.takeOffMessage();
